...
**แอดมิน** (`/admin`)
- แดชบอร์ด: ภาพรวม + งานที่ส่งล่าสุด + จำนวนรอตรวจ
- ห้องเรียน / รายวิชา / ชิ้นงาน (โจทย์ + คะแนนเต็ม + กำหนดส่ง)
- นักศึกษา: เพิ่มทีละคน หรือ **นำเข้า CSV** (ดูรูปแบบด้านล่าง)
- ลงทะเบียน: ผูกนักศึกษาเข้ารายวิชา (ทีละคน หรือทั้งห้อง)
- ตรวจ/ให้คะแนน: เลือกวิชา+ห้อง → ตารางนักศึกษา×งาน → เปิดลิงก์ → กรอกคะแนน → **Export CSV**

**นักศึกษา** (`/student`)
- เห็นเฉพาะวิชา/งานของตัวเอง โดยเน้น **งานที่ยังไม่ส่ง**
